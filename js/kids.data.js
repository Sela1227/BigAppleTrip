...
// ── Robot parts（DiceBear bottts 部位選項；即時組合用）──
const ROBOT_COLORS=['00acc1','1e88e5','5e35b1','e53935','fb8c00','43a047','c0ca33','8e24aa','f4511e','00897b','3949ab','d81b60'];
const ROBOT_EYES=['round','happy','hearts','glow','robocop','sensor','dizzy','eva','frame1','bulging','shade01','roundFrame01','frame2','roundFrame02'];
const ROBOT_MOUTHS=['smile01','smile02','diagram','grill01','grill02','grill03','bite','square01','square02'];
const ROBOT_TOPS=['antenna','antennaCrooked','bulb01','glowingBulb01','glowingBulb02','horns','lights','pyramid','radar'];
const ROBOT_FACES=['round01','round02','square01','square02','square03','square04'];
const ROBOT_SIDES=['round','square','antenna01','antenna02','cables01','cables02','squareAssymetric'];

...
const SPOTS=[
 ...
 {id:'edge',day:8,date:'7/12',icon:'🔭',name:'Edge 觀景台',color:'#2C4B7C',
  short:'踩在玻璃地板上看整個紐約！',
  story:`😱\nEdge 觀景台高約 335 公尺，是西半球最高的戶外觀景台，比 100 層樓還高！\n\n最讓人腿軟的是：地板是透明玻璃做的！你站在上面往腳下看，可以直接看到 300 公尺下的街道，超刺激！\n\n從這裡可以 360 度看整個紐約，包括自由女神、帝國大廈和布魯克林大橋，美得像一幅畫！`,
  facts:[{i:'🏢',t:'Edge 高約 335 公尺，站在上面感覺跟坐飛機差不多高！'},{i:'🪟',t:'地板是透明玻璃！站在上面往下看，可以直接看到地面！'},{i:'🌅',t:'天氣好的時候，可以看到 80 公里遠的地方，超遠！'},{i:'',t:'它是西半球最高的戶外觀景台！'},{i:'',t:'有一塊透明玻璃地板，往下看會腳軟！'}],
  quiz:[{q:'Edge 觀景台地板是什麼材料做的？',opts:['木頭','鋼鐵板','透明玻璃','特殊塑膠'],ans:2},{q:'站在 Edge 的透明地板上往下看會看到什麼？',opts:['好高的街道','大海','森林','沙漠'],ans:0}]},
...
const SPOTQ_EXTRA={
 ...
 edge:[
  {q:'Edge 觀景台大約有多高？',opts:['約335公尺','約33公尺','約1,000公尺','約100公尺'],ans:0},
  {q:'天氣好時站在 Edge 大約可以看到多遠？',opts:['約80公里','約8公里','約800公里','約8公尺'],ans:0},
  {q:'Edge 是西半球最高的什麼？',opts:['戶外觀景台','摩天輪','溜滑梯','噴水池'],ans:0}
 ],
 times:[
...
const SPOTQ_EXTRA2={
 ...
 edge:[
  {q:'站在 Edge 的透明地板往下看，大約看到多深的街道？',opts:['約300公尺下','約3公尺下','約30公尺下','約3公里下'],ans:0},
  {q:'Edge 觀景台比幾層樓還高？',opts:['100層樓','10層樓','5層樓','1層樓'],ans:0},
  {q:'從 Edge 可以看到幾度的紐約風景？',opts:['360度','90度','180度','45度'],ans:0},
  {q:'從 Edge 上可以看到哪個著名地標？',opts:['自由女神像','萬里長城','艾菲爾鐵塔','金門大橋'],ans:0}
 ],
 times:[
